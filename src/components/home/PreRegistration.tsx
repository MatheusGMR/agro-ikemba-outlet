...
export default function PreRegistration() {
  ...
  return (
    <section id="pre-cadastro" className="py-20 bg-gray-50">
      <div className="container-custom">
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold mb-4">Pré-cadastre-se para acesso antecipado</h3>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Button 
                type="submit" 
                className="w-full bg-agro-green hover:bg-agro-green-dark text-white py-3 text-lg"
