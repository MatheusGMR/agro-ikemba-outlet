...
export default function Hero() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-orange-50 to-white overflow-hidden">
      <div className="container-custom relative z-10 py-16 md:py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-lg md:text-xl font-medium text-amber-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button variant="outline" className="border-amber-700 text-amber-700 hover:bg-amber-700 hover:text-white px-8 py-6 text-lg">
                Saiba mais
              </Button>
            </div>
          ...
          <div className="relative flex-1 min-w-[300px] max-w-[600px]">
            <video 
              ...
              className="rounded-xl shadow-lg bg-orange-50"
      ...
      <div className="hidden md:block absolute -right-32 -top-32 w-96 h-96 bg-yellow-500/10 rounded-full blur-3xl"></div>
