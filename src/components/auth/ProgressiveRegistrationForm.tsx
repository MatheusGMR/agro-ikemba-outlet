...
export default function ProgressiveRegistrationForm() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const emailExists = await userService.checkEmailExists(finalData.email);
      if (emailExists) {
      ...
      const userData = await userService.addUser({
        ...
        conheceu: finalData.conheceu || null,
      });
    ...
    },
    {
      ...
      component: (
        <ButtonGrid
          ...
          value={formData.tipo}
          onSelect={(value) => setValue('tipo', value)}
          columns={2}
        />
      ),
    ...
    },
    {
      ...
      component: (
        <ButtonGrid
          ...
          onSelect={(value) => setValue('conheceu', value)}
          columns={3}
        />
      ),
      optional: true,
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-center space-y-3 pt-4">
              <p>
                Parabéns! Sua conta foi criada e você receberá um email com os próximos passos.
              </p>
