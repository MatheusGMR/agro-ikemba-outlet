...
const BlockingDialogTrigger = DialogPrimitive.Trigger;

const BlockingDialogOverlay = React.forwardRef<
...
BlockingDialogOverlay.displayName = DialogPrimitive.Overlay.displayName;
...
BlockingDialogContent.displayName = DialogPrimitive.Content.displayName;
