  ...
  return <footer className="bg-agro-green-dark text-white">
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Company info */}
          <div>
            <div className="flex items-center gap-1 mb-4 rounded-full mx-0 py-[29px]">
              <img alt="Agro Ikemba Logo" src="http://agroikemba.com.br/wp-content/uploads/2025/05/Add-a-heading-3.png" className="h-16 w-30 object-contain" />
            </div>
